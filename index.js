...
let first = artists[1 - 1];
// console.log(first);


//(2) Bio of the third artist (2nd index) in the array 
let secondIndex = artists[artists.length - 18];
// console.log(secondIndex['bio']);


/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 2 (not auto tested): 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 
(no function needed) 
There is a typo in your dataset 😱 The 9th artist, Vincent Van Gogh is currently Vincent Van Dough. Fix this issue and console.log() to check your work. */
let ninthIndex = artists[artists.length - 12];
ninthIndex['name'] = 'Vincet Van Gogh'
// console.log(ninthIndex['name']);
...
function artistByCountry(array, artNation){
  let filteredArtist = [];
  for (let i = 0; i < array.length; i++) {
    if (array[i].nationality === artNation) {
